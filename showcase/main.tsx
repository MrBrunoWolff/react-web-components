...
import '../src/components/ui/button-wc'
import '../src/components/ui-extra/flexlayout-wc'

// React components
import { Button } from '../src/components/ui/button'
import { FlexLayout } from '../src/components/ui-extra/flexlayout'
  ...
  layout: {
    ...
    children: [
      ...
      },
      {
        type: 'tabset',
        children: [
          { type: 'tab', name: 'Chart (react)', component: 'chart' }
        ]
      }
    ]
  }
...
// Initialize WC Button (already in HTML) – nothing to do, but can access:
{
  ...
  wcBtn?.addEventListener('click', () => console.log('WC button clicked'))
}
...
{
  const wc = document.getElementById('flex-wc') as any
  if (wc) {
      ...
      layout: {
        ...
        children: [
          ...
          },
          {
            type: 'tabset',
            children: [
              { type: 'tab', name: 'Chart (wc)', component: 'chart' }
            ]
          }
        ]
      }
